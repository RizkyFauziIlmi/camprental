...
const itemData: Item[] = [
  {
    ...
    imageUrl: faker.image.urlLoremFlickr({ category: "compass" }),
    ...
    maxDate: addDays(new Date(), faker.number.int({ min: 1, max: 7 })),
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    maxDate: addDays(new Date(), faker.number.int({ min: 1, max: 14 })),
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    maxDate: addDays(new Date(), faker.number.int({ min: 1, max: 10 })),
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
